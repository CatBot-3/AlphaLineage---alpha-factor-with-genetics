...
from alphaforge.backtest.costs import turnover_series
from alphaforge.core.fitness import daily_ic, forward_returns
...
def turnover(weights: pd.DataFrame) -> float:
    """Mean per-rebalance turnover ``Σ|Δw|`` (excluding the initial establishment)."""
