...
default, overridable via the ``ALPHAFORGE_DATA_DIR`` environment variable):
...
def ensure_dirs() -> None:
    ...
    for directory in (prices_dir(), universe_dir(), reports_dir(), meta_dir()):
